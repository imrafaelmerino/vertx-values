...
public class SendMessageToEventBus {
    ...
    public void vertx_values_array(Blackhole blackHole) {
        blackHole.consume(vertx.eventBus().request("bounce", immutableJsonArray)
                .toCompletionStage()
                .toCompletableFuture()
                .join());
    }
    ...
    public void vertx_jackson_array(Blackhole blackHole) {
        blackHole.consume(vertx.eventBus().request("bounce", mutableJsonArray)
                .toCompletionStage()
                .toCompletableFuture()
                .join());
